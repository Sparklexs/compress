...
import me.lemire.compression.BinaryPacking;
import me.lemire.compression.ByteIntegerCODEC;
import me.lemire.compression.Composition;
import me.lemire.compression.Delta;
import me.lemire.compression.DeltaZigzagBinaryPacking;
import me.lemire.compression.DeltaZigzagVariableByte;
...
import me.lemire.compression.IntegratedFastPFOR;
import me.lemire.compression.IntegratedIntegerCODEC;
import me.lemire.compression.IntegratedVariableByte;
import me.lemire.compression.JustCopy;
import me.lemire.compression.NewPFD;
import me.lemire.compression.NewPFDS16;
import me.lemire.compression.NewPFDS9;
import me.lemire.compression.OptPFD;
import me.lemire.compression.OptPFDS16;
import me.lemire.compression.OptPFDS9;
import me.lemire.compression.Simple9;
import me.lemire.compression.VariableByte;
import me.lemire.compression.XorBinaryPacking;
...
public class Benchmark
{
	...
	private static void test(PrintWriter csvLog, int N, int nbr, int repeat)
	{
		...
		for (int sparsity = 1; sparsity < max_sparsity; ++sparsity)
		{
			...
			testByteCodec(csvLog, sparsity, new IntegratedVariableByte(), data,
			        repeat, false);
			testByteCodec(csvLog, sparsity, new IntegratedVariableByte(), data,
			        repeat, false);
			testByteCodec(csvLog, sparsity, new IntegratedVariableByte(), data,
