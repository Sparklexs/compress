...
import me.lemire.compression.IntegratedBitPacking;
	...
	private static void testWithDeltas(boolean verbose)
	{
		...
		for (int bit = 1; bit < 31; ++bit)
		{
			...
			for (int t = 0; t < times; ++t)
			{
				...
				IntegratedBitPacking.integratedpack(0, tmpdata, 0, icompressed,
				        0, bit);
				time2 = System.nanoTime();
				IntegratedBitPacking.integratedunpack(0, icompressed, 0,
				        uncompressed, 0, bit);
