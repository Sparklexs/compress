...
public final class IntegratedBitPacking
{
	...
	protected static void integratedpack1(final int initoffset, final int[] in,
	        int inpos, final int[] out, int outpos)
	{
	...
	protected static void integratedpack2(final int initoffset, final int[] in,
	        int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (in[0 + inpos] - initoffset)
	...
	protected static void integratedpack3(final int initoffset, final int[] in,
	        int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (in[0 + inpos] - initoffset)
	...
	protected static void integratedpack4(final int initoffset, final int[] in,
	        int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (in[0 + inpos] - initoffset)
	...
	protected static void integratedpack5(final int initoffset, final int[] in,
	        int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (in[0 + inpos] - initoffset)
	...
	protected static void integratedpack6(final int initoffset, final int[] in,
	        int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (in[0 + inpos] - initoffset)
	...
	protected static void integratedpack7(final int initoffset, final int[] in,
	        int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (in[0 + inpos] - initoffset)
	...
	protected static void integratedpack8(final int initoffset, final int[] in,
	        int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (in[0 + inpos] - initoffset)
	...
	protected static void integratedpack9(final int initoffset, final int[] in,
	        int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (in[0 + inpos] - initoffset)
	        ...
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		...
		out[1 + outpos] = (((in[0 + inpos] >>> 1) & 1)) + out[1 + outpos - 1];
		out[2 + outpos] = (((in[0 + inpos] >>> 2) & 1)) + out[2 + outpos - 1];
		out[3 + outpos] = (((in[0 + inpos] >>> 3) & 1)) + out[3 + outpos - 1];
		out[4 + outpos] = (((in[0 + inpos] >>> 4) & 1)) + out[4 + outpos - 1];
		out[5 + outpos] = (((in[0 + inpos] >>> 5) & 1)) + out[5 + outpos - 1];
		out[6 + outpos] = (((in[0 + inpos] >>> 6) & 1)) + out[6 + outpos - 1];
		out[7 + outpos] = (((in[0 + inpos] >>> 7) & 1)) + out[7 + outpos - 1];
		out[8 + outpos] = (((in[0 + inpos] >>> 8) & 1)) + out[8 + outpos - 1];
		out[9 + outpos] = (((in[0 + inpos] >>> 9) & 1)) + out[9 + outpos - 1];
		...
		out[30 + outpos] = (((in[0 + inpos] >>> 30) & 1))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[0 + inpos] >>> 31)) + out[31 + outpos - 1];
	}
	        ...
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		...
		out[1 + outpos] = (((in[0 + inpos] >>> 2) & 3)) + out[1 + outpos - 1];
		out[2 + outpos] = (((in[0 + inpos] >>> 4) & 3)) + out[2 + outpos - 1];
		out[3 + outpos] = (((in[0 + inpos] >>> 6) & 3)) + out[3 + outpos - 1];
		out[4 + outpos] = (((in[0 + inpos] >>> 8) & 3)) + out[4 + outpos - 1];
		out[5 + outpos] = (((in[0 + inpos] >>> 10) & 3)) + out[5 + outpos - 1];
		out[6 + outpos] = (((in[0 + inpos] >>> 12) & 3)) + out[6 + outpos - 1];
		out[7 + outpos] = (((in[0 + inpos] >>> 14) & 3)) + out[7 + outpos - 1];
		out[8 + outpos] = (((in[0 + inpos] >>> 16) & 3)) + out[8 + outpos - 1];
		out[9 + outpos] = (((in[0 + inpos] >>> 18) & 3)) + out[9 + outpos - 1];
		...
		out[14 + outpos] = (((in[0 + inpos] >>> 28) & 3))
		        + out[14 + outpos - 1];
		out[15 + outpos] = ((in[0 + inpos] >>> 30)) + out[15 + outpos - 1];
		out[16 + outpos] = (((in[1 + inpos] >>> 0) & 3)) + out[16 + outpos - 1];
		out[17 + outpos] = (((in[1 + inpos] >>> 2) & 3)) + out[17 + outpos - 1];
		out[18 + outpos] = (((in[1 + inpos] >>> 4) & 3)) + out[18 + outpos - 1];
		out[19 + outpos] = (((in[1 + inpos] >>> 6) & 3)) + out[19 + outpos - 1];
		out[20 + outpos] = (((in[1 + inpos] >>> 8) & 3)) + out[20 + outpos - 1];
		...
		out[30 + outpos] = (((in[1 + inpos] >>> 28) & 3))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[1 + inpos] >>> 30)) + out[31 + outpos - 1];
	}
	        ...
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		...
		out[1 + outpos] = (((in[0 + inpos] >>> 3) & 7)) + out[1 + outpos - 1];
		out[2 + outpos] = (((in[0 + inpos] >>> 6) & 7)) + out[2 + outpos - 1];
		out[3 + outpos] = (((in[0 + inpos] >>> 9) & 7)) + out[3 + outpos - 1];
		out[4 + outpos] = (((in[0 + inpos] >>> 12) & 7)) + out[4 + outpos - 1];
		out[5 + outpos] = (((in[0 + inpos] >>> 15) & 7)) + out[5 + outpos - 1];
		out[6 + outpos] = (((in[0 + inpos] >>> 18) & 7)) + out[6 + outpos - 1];
		out[7 + outpos] = (((in[0 + inpos] >>> 21) & 7)) + out[7 + outpos - 1];
		out[8 + outpos] = (((in[0 + inpos] >>> 24) & 7)) + out[8 + outpos - 1];
		out[9 + outpos] = (((in[0 + inpos] >>> 27) & 7)) + out[9 + outpos - 1];
		out[10 + outpos] = ((in[0 + inpos] >>> 30) | ((in[1 + inpos] & 1) << (3 - 1)))
		        + out[10 + outpos - 1];
		out[11 + outpos] = (((in[1 + inpos] >>> 1) & 7)) + out[11 + outpos - 1];
		out[12 + outpos] = (((in[1 + inpos] >>> 4) & 7)) + out[12 + outpos - 1];
		out[13 + outpos] = (((in[1 + inpos] >>> 7) & 7)) + out[13 + outpos - 1];
		...
		out[21 + outpos] = ((in[1 + inpos] >>> 31) | ((in[2 + inpos] & 3) << (3 - 2)))
		        + out[21 + outpos - 1];
		out[22 + outpos] = (((in[2 + inpos] >>> 2) & 7)) + out[22 + outpos - 1];
		out[23 + outpos] = (((in[2 + inpos] >>> 5) & 7)) + out[23 + outpos - 1];
		out[24 + outpos] = (((in[2 + inpos] >>> 8) & 7)) + out[24 + outpos - 1];
		...
		out[30 + outpos] = (((in[2 + inpos] >>> 26) & 7))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[2 + inpos] >>> 29)) + out[31 + outpos - 1];
	}
	        ...
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		...
		out[1 + outpos] = (((in[0 + inpos] >>> 4) & 15)) + out[1 + outpos - 1];
		out[2 + outpos] = (((in[0 + inpos] >>> 8) & 15)) + out[2 + outpos - 1];
		out[3 + outpos] = (((in[0 + inpos] >>> 12) & 15)) + out[3 + outpos - 1];
		out[4 + outpos] = (((in[0 + inpos] >>> 16) & 15)) + out[4 + outpos - 1];
		out[5 + outpos] = (((in[0 + inpos] >>> 20) & 15)) + out[5 + outpos - 1];
		out[6 + outpos] = (((in[0 + inpos] >>> 24) & 15)) + out[6 + outpos - 1];
		out[7 + outpos] = ((in[0 + inpos] >>> 28)) + out[7 + outpos - 1];
		out[8 + outpos] = (((in[1 + inpos] >>> 0) & 15)) + out[8 + outpos - 1];
		out[9 + outpos] = (((in[1 + inpos] >>> 4) & 15)) + out[9 + outpos - 1];
		...
		out[14 + outpos] = (((in[1 + inpos] >>> 24) & 15))
		        + out[14 + outpos - 1];
		out[15 + outpos] = ((in[1 + inpos] >>> 28)) + out[15 + outpos - 1];
		...
		out[22 + outpos] = (((in[2 + inpos] >>> 24) & 15))
		        + out[22 + outpos - 1];
		out[23 + outpos] = ((in[2 + inpos] >>> 28)) + out[23 + outpos - 1];
		...
		out[30 + outpos] = (((in[3 + inpos] >>> 24) & 15))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[3 + inpos] >>> 28)) + out[31 + outpos - 1];
	}
	        ...
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		...
		out[1 + outpos] = (((in[0 + inpos] >>> 5) & 31)) + out[1 + outpos - 1];
		out[2 + outpos] = (((in[0 + inpos] >>> 10) & 31)) + out[2 + outpos - 1];
		out[3 + outpos] = (((in[0 + inpos] >>> 15) & 31)) + out[3 + outpos - 1];
		out[4 + outpos] = (((in[0 + inpos] >>> 20) & 31)) + out[4 + outpos - 1];
		out[5 + outpos] = (((in[0 + inpos] >>> 25) & 31)) + out[5 + outpos - 1];
		out[6 + outpos] = ((in[0 + inpos] >>> 30) | ((in[1 + inpos] & 7) << (5 - 3)))
		        + out[6 + outpos - 1];
		out[7 + outpos] = (((in[1 + inpos] >>> 3) & 31)) + out[7 + outpos - 1];
		out[8 + outpos] = (((in[1 + inpos] >>> 8) & 31)) + out[8 + outpos - 1];
		out[9 + outpos] = (((in[1 + inpos] >>> 13) & 31)) + out[9 + outpos - 1];
		...
		out[30 + outpos] = (((in[4 + inpos] >>> 22) & 31))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[4 + inpos] >>> 27)) + out[31 + outpos - 1];
	}
	        ...
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		...
		out[1 + outpos] = (((in[0 + inpos] >>> 6) & 63)) + out[1 + outpos - 1];
		out[2 + outpos] = (((in[0 + inpos] >>> 12) & 63)) + out[2 + outpos - 1];
		out[3 + outpos] = (((in[0 + inpos] >>> 18) & 63)) + out[3 + outpos - 1];
		out[4 + outpos] = (((in[0 + inpos] >>> 24) & 63)) + out[4 + outpos - 1];
		out[5 + outpos] = ((in[0 + inpos] >>> 30) | ((in[1 + inpos] & 15) << (6 - 4)))
		        + out[5 + outpos - 1];
		out[6 + outpos] = (((in[1 + inpos] >>> 4) & 63)) + out[6 + outpos - 1];
		out[7 + outpos] = (((in[1 + inpos] >>> 10) & 63)) + out[7 + outpos - 1];
		out[8 + outpos] = (((in[1 + inpos] >>> 16) & 63)) + out[8 + outpos - 1];
		out[9 + outpos] = (((in[1 + inpos] >>> 22) & 63)) + out[9 + outpos - 1];
		...
		out[14 + outpos] = (((in[2 + inpos] >>> 20) & 63))
		        + out[14 + outpos - 1];
		out[15 + outpos] = ((in[2 + inpos] >>> 26)) + out[15 + outpos - 1];
		...
		out[30 + outpos] = (((in[5 + inpos] >>> 20) & 63))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[5 + inpos] >>> 26)) + out[31 + outpos - 1];
	}
	        ...
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		...
		out[1 + outpos] = (((in[0 + inpos] >>> 7) & 127)) + out[1 + outpos - 1];
		...
		out[4 + outpos] = ((in[0 + inpos] >>> 28) | ((in[1 + inpos] & 7) << (7 - 3)))
		        + out[4 + outpos - 1];
		out[5 + outpos] = (((in[1 + inpos] >>> 3) & 127)) + out[5 + outpos - 1];
		...
		out[30 + outpos] = (((in[6 + inpos] >>> 18) & 127))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[6 + inpos] >>> 25)) + out[31 + outpos - 1];
	}
	        ...
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		...
		out[1 + outpos] = (((in[0 + inpos] >>> 8) & 255)) + out[1 + outpos - 1];
		out[2 + outpos] = (((in[0 + inpos] >>> 16) & 255))
		        + out[2 + outpos - 1];
		out[3 + outpos] = ((in[0 + inpos] >>> 24)) + out[3 + outpos - 1];
		out[4 + outpos] = (((in[1 + inpos] >>> 0) & 255)) + out[4 + outpos - 1];
		out[5 + outpos] = (((in[1 + inpos] >>> 8) & 255)) + out[5 + outpos - 1];
		out[6 + outpos] = (((in[1 + inpos] >>> 16) & 255))
		        + out[6 + outpos - 1];
		out[7 + outpos] = ((in[1 + inpos] >>> 24)) + out[7 + outpos - 1];
		out[8 + outpos] = (((in[2 + inpos] >>> 0) & 255)) + out[8 + outpos - 1];
		out[9 + outpos] = (((in[2 + inpos] >>> 8) & 255)) + out[9 + outpos - 1];
		out[10 + outpos] = (((in[2 + inpos] >>> 16) & 255))
		        + out[10 + outpos - 1];
		out[11 + outpos] = ((in[2 + inpos] >>> 24)) + out[11 + outpos - 1];
		...
		out[14 + outpos] = (((in[3 + inpos] >>> 16) & 255))
		        + out[14 + outpos - 1];
		out[15 + outpos] = ((in[3 + inpos] >>> 24)) + out[15 + outpos - 1];
		...
		out[18 + outpos] = (((in[4 + inpos] >>> 16) & 255))
		        + out[18 + outpos - 1];
		out[19 + outpos] = ((in[4 + inpos] >>> 24)) + out[19 + outpos - 1];
		...
		out[22 + outpos] = (((in[5 + inpos] >>> 16) & 255))
		        + out[22 + outpos - 1];
		out[23 + outpos] = ((in[5 + inpos] >>> 24)) + out[23 + outpos - 1];
		...
		out[26 + outpos] = (((in[6 + inpos] >>> 16) & 255))
		        + out[26 + outpos - 1];
		out[27 + outpos] = ((in[6 + inpos] >>> 24)) + out[27 + outpos - 1];
		...
		out[30 + outpos] = (((in[7 + inpos] >>> 16) & 255))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[7 + inpos] >>> 24)) + out[31 + outpos - 1];
	}
	        ...
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		...
		out[1 + outpos] = (((in[0 + inpos] >>> 9) & 511)) + out[1 + outpos - 1];
		out[2 + outpos] = (((in[0 + inpos] >>> 18) & 511))
		        + out[2 + outpos - 1];
		out[3 + outpos] = ((in[0 + inpos] >>> 27) | ((in[1 + inpos] & 15) << (9 - 4)))
		        + out[3 + outpos - 1];
		out[4 + outpos] = (((in[1 + inpos] >>> 4) & 511)) + out[4 + outpos - 1];
		...
		out[7 + outpos] = ((in[1 + inpos] >>> 31) | ((in[2 + inpos] & 255) << (9 - 8)))
		        + out[7 + outpos - 1];
		out[8 + outpos] = (((in[2 + inpos] >>> 8) & 511)) + out[8 + outpos - 1];
		...
		out[30 + outpos] = (((in[8 + inpos] >>> 14) & 511))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[8 + inpos] >>> 23)) + out[31 + outpos - 1];
	}
	        ...
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		...
		out[14 + outpos] = (((in[4 + inpos] >>> 12) & 1023))
		        + out[14 + outpos - 1];
		out[15 + outpos] = ((in[4 + inpos] >>> 22)) + out[15 + outpos - 1];
		...
		out[30 + outpos] = (((in[9 + inpos] >>> 12) & 1023))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[9 + inpos] >>> 22)) + out[31 + outpos - 1];
	}
	        ...
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		...
		out[30 + outpos] = (((in[10 + inpos] >>> 10) & 2047))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[10 + inpos] >>> 21)) + out[31 + outpos - 1];
	}
	        ...
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		...
		out[6 + outpos] = (((in[2 + inpos] >>> 8) & 4095))
		        + out[6 + outpos - 1];
		out[7 + outpos] = ((in[2 + inpos] >>> 20)) + out[7 + outpos - 1];
		...
		out[14 + outpos] = (((in[5 + inpos] >>> 8) & 4095))
		        + out[14 + outpos - 1];
		out[15 + outpos] = ((in[5 + inpos] >>> 20)) + out[15 + outpos - 1];
		...
		out[22 + outpos] = (((in[8 + inpos] >>> 8) & 4095))
		        + out[22 + outpos - 1];
		out[23 + outpos] = ((in[8 + inpos] >>> 20)) + out[23 + outpos - 1];
		...
		out[30 + outpos] = (((in[11 + inpos] >>> 8) & 4095))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[11 + inpos] >>> 20)) + out[31 + outpos - 1];
	}
	        ...
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		...
		out[30 + outpos] = (((in[12 + inpos] >>> 6) & 8191))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[12 + inpos] >>> 19)) + out[31 + outpos - 1];
	}

	protected static void integratedunpack14(final int initoffset,
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (((in[0 + inpos] >>> 0) & 16383)) + initoffset;
		...
		out[14 + outpos] = (((in[6 + inpos] >>> 4) & 16383))
		        + out[14 + outpos - 1];
		out[15 + outpos] = ((in[6 + inpos] >>> 18)) + out[15 + outpos - 1];
		...
		out[30 + outpos] = (((in[13 + inpos] >>> 4) & 16383))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[13 + inpos] >>> 18)) + out[31 + outpos - 1];
	}

	protected static void integratedunpack15(final int initoffset,
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (((in[0 + inpos] >>> 0) & 32767)) + initoffset;
		...
		out[30 + outpos] = (((in[14 + inpos] >>> 2) & 32767))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[14 + inpos] >>> 17)) + out[31 + outpos - 1];
	}

	protected static void integratedunpack16(final int initoffset,
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (((in[0 + inpos] >>> 0) & 65535)) + initoffset;
		out[1 + outpos] = ((in[0 + inpos] >>> 16)) + out[1 + outpos - 1];
		out[2 + outpos] = (((in[1 + inpos] >>> 0) & 65535))
		        + out[2 + outpos - 1];
		out[3 + outpos] = ((in[1 + inpos] >>> 16)) + out[3 + outpos - 1];
		out[4 + outpos] = (((in[2 + inpos] >>> 0) & 65535))
		        + out[4 + outpos - 1];
		out[5 + outpos] = ((in[2 + inpos] >>> 16)) + out[5 + outpos - 1];
		out[6 + outpos] = (((in[3 + inpos] >>> 0) & 65535))
		        + out[6 + outpos - 1];
		out[7 + outpos] = ((in[3 + inpos] >>> 16)) + out[7 + outpos - 1];
		out[8 + outpos] = (((in[4 + inpos] >>> 0) & 65535))
		        + out[8 + outpos - 1];
		out[9 + outpos] = ((in[4 + inpos] >>> 16)) + out[9 + outpos - 1];
		out[10 + outpos] = (((in[5 + inpos] >>> 0) & 65535))
		        + out[10 + outpos - 1];
		out[11 + outpos] = ((in[5 + inpos] >>> 16)) + out[11 + outpos - 1];
		out[12 + outpos] = (((in[6 + inpos] >>> 0) & 65535))
		        + out[12 + outpos - 1];
		out[13 + outpos] = ((in[6 + inpos] >>> 16)) + out[13 + outpos - 1];
		out[14 + outpos] = (((in[7 + inpos] >>> 0) & 65535))
		        + out[14 + outpos - 1];
		out[15 + outpos] = ((in[7 + inpos] >>> 16)) + out[15 + outpos - 1];
		out[16 + outpos] = (((in[8 + inpos] >>> 0) & 65535))
		        + out[16 + outpos - 1];
		out[17 + outpos] = ((in[8 + inpos] >>> 16)) + out[17 + outpos - 1];
		out[18 + outpos] = (((in[9 + inpos] >>> 0) & 65535))
		        + out[18 + outpos - 1];
		out[19 + outpos] = ((in[9 + inpos] >>> 16)) + out[19 + outpos - 1];
		out[20 + outpos] = (((in[10 + inpos] >>> 0) & 65535))
		        + out[20 + outpos - 1];
		out[21 + outpos] = ((in[10 + inpos] >>> 16)) + out[21 + outpos - 1];
		out[22 + outpos] = (((in[11 + inpos] >>> 0) & 65535))
		        + out[22 + outpos - 1];
		out[23 + outpos] = ((in[11 + inpos] >>> 16)) + out[23 + outpos - 1];
		out[24 + outpos] = (((in[12 + inpos] >>> 0) & 65535))
		        + out[24 + outpos - 1];
		out[25 + outpos] = ((in[12 + inpos] >>> 16)) + out[25 + outpos - 1];
		out[26 + outpos] = (((in[13 + inpos] >>> 0) & 65535))
		        + out[26 + outpos - 1];
		out[27 + outpos] = ((in[13 + inpos] >>> 16)) + out[27 + outpos - 1];
		out[28 + outpos] = (((in[14 + inpos] >>> 0) & 65535))
		        + out[28 + outpos - 1];
		out[29 + outpos] = ((in[14 + inpos] >>> 16)) + out[29 + outpos - 1];
		out[30 + outpos] = (((in[15 + inpos] >>> 0) & 65535))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[15 + inpos] >>> 16)) + out[31 + outpos - 1];
	}

	protected static void integratedunpack17(final int initoffset,
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (((in[0 + inpos] >>> 0) & 131071)) + initoffset;
		...
		out[30 + outpos] = ((in[15 + inpos] >>> 30) | ((in[16 + inpos] & 32767) << (17 - 15)))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[16 + inpos] >>> 15)) + out[31 + outpos - 1];
	}

	protected static void integratedunpack18(final int initoffset,
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (((in[0 + inpos] >>> 0) & 262143)) + initoffset;
		...
		out[14 + outpos] = ((in[7 + inpos] >>> 28) | ((in[8 + inpos] & 16383) << (18 - 14)))
		        + out[14 + outpos - 1];
		out[15 + outpos] = ((in[8 + inpos] >>> 14)) + out[15 + outpos - 1];
		...
		out[30 + outpos] = ((in[16 + inpos] >>> 28) | ((in[17 + inpos] & 16383) << (18 - 14)))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[17 + inpos] >>> 14)) + out[31 + outpos - 1];
	}

	protected static void integratedunpack19(final int initoffset,
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (((in[0 + inpos] >>> 0) & 524287)) + initoffset;
		...
		out[30 + outpos] = ((in[17 + inpos] >>> 26) | ((in[18 + inpos] & 8191) << (19 - 13)))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[18 + inpos] >>> 13)) + out[31 + outpos - 1];
	}

	protected static void integratedunpack20(final int initoffset,
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (((in[0 + inpos] >>> 0) & 1048575)) + initoffset;
		...
		out[6 + outpos] = ((in[3 + inpos] >>> 24) | ((in[4 + inpos] & 4095) << (20 - 12)))
		        + out[6 + outpos - 1];
		out[7 + outpos] = ((in[4 + inpos] >>> 12)) + out[7 + outpos - 1];
		...
		out[14 + outpos] = ((in[8 + inpos] >>> 24) | ((in[9 + inpos] & 4095) << (20 - 12)))
		        + out[14 + outpos - 1];
		out[15 + outpos] = ((in[9 + inpos] >>> 12)) + out[15 + outpos - 1];
		...
		out[22 + outpos] = ((in[13 + inpos] >>> 24) | ((in[14 + inpos] & 4095) << (20 - 12)))
		        + out[22 + outpos - 1];
		out[23 + outpos] = ((in[14 + inpos] >>> 12)) + out[23 + outpos - 1];
		...
		out[30 + outpos] = ((in[18 + inpos] >>> 24) | ((in[19 + inpos] & 4095) << (20 - 12)))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[19 + inpos] >>> 12)) + out[31 + outpos - 1];
	}

	protected static void integratedunpack21(final int initoffset,
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (((in[0 + inpos] >>> 0) & 2097151)) + initoffset;
		...
		out[30 + outpos] = ((in[19 + inpos] >>> 22) | ((in[20 + inpos] & 2047) << (21 - 11)))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[20 + inpos] >>> 11)) + out[31 + outpos - 1];
	}

	protected static void integratedunpack22(final int initoffset,
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (((in[0 + inpos] >>> 0) & 4194303)) + initoffset;
		...
		out[14 + outpos] = ((in[9 + inpos] >>> 20) | ((in[10 + inpos] & 1023) << (22 - 10)))
		        + out[14 + outpos - 1];
		out[15 + outpos] = ((in[10 + inpos] >>> 10)) + out[15 + outpos - 1];
		...
		out[30 + outpos] = ((in[20 + inpos] >>> 20) | ((in[21 + inpos] & 1023) << (22 - 10)))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[21 + inpos] >>> 10)) + out[31 + outpos - 1];
	}

	protected static void integratedunpack23(final int initoffset,
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (((in[0 + inpos] >>> 0) & 8388607)) + initoffset;
		...
		out[30 + outpos] = ((in[21 + inpos] >>> 18) | ((in[22 + inpos] & 511) << (23 - 9)))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[22 + inpos] >>> 9)) + out[31 + outpos - 1];
	}

	protected static void integratedunpack24(final int initoffset,
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (((in[0 + inpos] >>> 0) & 16777215)) + initoffset;
		...
		out[10 + outpos] = ((in[7 + inpos] >>> 16) | ((in[8 + inpos] & 255) << (24 - 8)))
		        + out[10 + outpos - 1];
		out[11 + outpos] = ((in[8 + inpos] >>> 8)) + out[11 + outpos - 1];
		...
		out[14 + outpos] = ((in[10 + inpos] >>> 16) | ((in[11 + inpos] & 255) << (24 - 8)))
		        + out[14 + outpos - 1];
		out[15 + outpos] = ((in[11 + inpos] >>> 8)) + out[15 + outpos - 1];
		...
		out[18 + outpos] = ((in[13 + inpos] >>> 16) | ((in[14 + inpos] & 255) << (24 - 8)))
		        + out[18 + outpos - 1];
		out[19 + outpos] = ((in[14 + inpos] >>> 8)) + out[19 + outpos - 1];
		...
		out[22 + outpos] = ((in[16 + inpos] >>> 16) | ((in[17 + inpos] & 255) << (24 - 8)))
		        + out[22 + outpos - 1];
		out[23 + outpos] = ((in[17 + inpos] >>> 8)) + out[23 + outpos - 1];
		...
		out[26 + outpos] = ((in[19 + inpos] >>> 16) | ((in[20 + inpos] & 255) << (24 - 8)))
		        + out[26 + outpos - 1];
		out[27 + outpos] = ((in[20 + inpos] >>> 8)) + out[27 + outpos - 1];
		...
		out[30 + outpos] = ((in[22 + inpos] >>> 16) | ((in[23 + inpos] & 255) << (24 - 8)))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[23 + inpos] >>> 8)) + out[31 + outpos - 1];
	}

	protected static void integratedunpack25(final int initoffset,
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (((in[0 + inpos] >>> 0) & 33554431)) + initoffset;
		...
		out[30 + outpos] = ((in[23 + inpos] >>> 14) | ((in[24 + inpos] & 127) << (25 - 7)))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[24 + inpos] >>> 7)) + out[31 + outpos - 1];
	}

	protected static void integratedunpack26(final int initoffset,
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (((in[0 + inpos] >>> 0) & 67108863)) + initoffset;
		...
		out[14 + outpos] = ((in[11 + inpos] >>> 12) | ((in[12 + inpos] & 63) << (26 - 6)))
		        + out[14 + outpos - 1];
		out[15 + outpos] = ((in[12 + inpos] >>> 6)) + out[15 + outpos - 1];
		...
		out[30 + outpos] = ((in[24 + inpos] >>> 12) | ((in[25 + inpos] & 63) << (26 - 6)))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[25 + inpos] >>> 6)) + out[31 + outpos - 1];
	}

	protected static void integratedunpack27(final int initoffset,
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (((in[0 + inpos] >>> 0) & 134217727)) + initoffset;
		...
		out[30 + outpos] = ((in[25 + inpos] >>> 10) | ((in[26 + inpos] & 31) << (27 - 5)))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[26 + inpos] >>> 5)) + out[31 + outpos - 1];
	}

	protected static void integratedunpack28(final int initoffset,
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (((in[0 + inpos] >>> 0) & 268435455)) + initoffset;
		...
		out[14 + outpos] = ((in[12 + inpos] >>> 8) | ((in[13 + inpos] & 15) << (28 - 4)))
		        + out[14 + outpos - 1];
		out[15 + outpos] = ((in[13 + inpos] >>> 4)) + out[15 + outpos - 1];
		...
		out[22 + outpos] = ((in[19 + inpos] >>> 8) | ((in[20 + inpos] & 15) << (28 - 4)))
		        + out[22 + outpos - 1];
		out[23 + outpos] = ((in[20 + inpos] >>> 4)) + out[23 + outpos - 1];
		...
		out[30 + outpos] = ((in[26 + inpos] >>> 8) | ((in[27 + inpos] & 15) << (28 - 4)))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[27 + inpos] >>> 4)) + out[31 + outpos - 1];
	}

	protected static void integratedunpack29(final int initoffset,
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (((in[0 + inpos] >>> 0) & 536870911)) + initoffset;
		...
		out[30 + outpos] = ((in[27 + inpos] >>> 6) | ((in[28 + inpos] & 7) << (29 - 3)))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[28 + inpos] >>> 3)) + out[31 + outpos - 1];
	}

	protected static void integratedunpack30(final int initoffset,
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (((in[0 + inpos] >>> 0) & 1073741823)) + initoffset;
		...
		out[14 + outpos] = ((in[13 + inpos] >>> 4) | ((in[14 + inpos] & 3) << (30 - 2)))
		        + out[14 + outpos - 1];
		out[15 + outpos] = ((in[14 + inpos] >>> 2)) + out[15 + outpos - 1];
		...
		out[30 + outpos] = ((in[28 + inpos] >>> 4) | ((in[29 + inpos] & 3) << (30 - 2)))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[29 + inpos] >>> 2)) + out[31 + outpos - 1];
	}

	protected static void integratedunpack31(final int initoffset,
	        final int[] in, int inpos, final int[] out, int outpos)
	{
		out[0 + outpos] = (((in[0 + inpos] >>> 0) & 2147483647)) + initoffset;
		...
		out[30 + outpos] = ((in[29 + inpos] >>> 2) | ((in[30 + inpos] & 1) << (31 - 1)))
		        + out[30 + outpos - 1];
		out[31 + outpos] = ((in[30 + inpos] >>> 1)) + out[31 + outpos - 1];
	}
	...
	protected static void integratedpack0(final int initoffset, final int[] in,
	        int inpos, final int[] out, int outpos)
	{
		// nothing
	}
	 ...
	 *            source array
	 * @param inpos
	 *            initial position in source array
	 * @param out
	 *            output array
	 * @param outpos
	 *            initial position in output array
	 * @param bit
	 *            number of bits to use per integer
	 */
	public static void integratedunpack(final int initoffset, final int[] in,
	 ...
	 * 
	 * @param initoffset
	 *            initial value (used to compute first delta)
	 * @param in
	 *            input array
	 * @param inpos
