...
public final class S16
{
	...
	public static int compress(final int[] in, int currentPos, int inlength,
	...
	public static int uncompress(final int[] in, int tmpinpos,
	        final int inlength, final int[] out, int currentPos, int outlength)
	{
	...
	private static final int[]	 S16_NUM	         = { 28, 21, 21, 21, 14, 9,
	        8, 7, 6, 6, 5, 5, 4, 3, 2, 1	         };
